...
<html>  
	...
	<body>
		...
		<h2>Current Effort Reporting Period (<g:formatDate date="${reportingPeriodInstance.periodDate}" format="MMMM yyyy" />)</h2>
        ...
        <!-- Otherwise, include for various dynamic FORMS (include) -->
        <g:if test="${assignedEffortInstance && !assignedEffortInstance.dateCommitted}">
        ...
        <!-- PAST COMMITTED EFFORT SECTION (include) -->
        <g:include 
