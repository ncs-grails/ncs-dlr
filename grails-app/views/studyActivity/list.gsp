                ...
                <table>
                    ...
                    <g:each in="${studyActivityInstanceList}" status="i" var="studyActivityInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td><g:link action="show" id="${studyActivityInstance.id}">${fieldValue(bean: studyActivityInstance, field: "id")}</g:link></td>
                        
                            <td>${fieldValue(bean: studyActivityInstance, field: "name")}</td>
                        
                            <td><g:formatBoolean boolean="${studyActivityInstance.obsolete}" /></td>
                        
                            <td><g:formatDate date="${studyActivityInstance.dateCreated}" /></td>
