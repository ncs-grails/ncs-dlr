              ...
              <tbody>
                ...
                <tr class="prop">
                    <td valign="top" class="name">
                        <label for="name">
                          <g:message code="studyActivity.name.label" default="Name" />
                        </label>
                    </td>
                ...
                <tr class="prop">
                    <td valign="top" class="name">
                        <label for="obsolete">
                          <g:message code="studyActivity.obsolete.label" default="Obsolete" />
                        </label>
                    </td>
                ...
                <tr class="prop">
                    <td valign="top" class="name">
                        <label for="userCreated">
                          <g:message code="studyActivity.userCreated.label" default="User Created" />
                        </label>
                    </td>
                ...
                <tr class="prop">
                    <td valign="top" class="name">
                        <label for="appCreated">
                          <g:message code="studyActivity.appCreated.label" default="App Created" />
                        </label>
                    </td>
